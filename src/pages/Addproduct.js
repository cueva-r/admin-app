...
let schema = yup.object().shape({
    ...
    brand: yup.string().required("La marca es requrida"),
    category: yup.string().required("La categoría es requerida"),
    tags: yup.string().required("La etiqueta es requerida"),
    color: yup
        .array()
            ...
            <div>
                ...
                >
                    ...
                    <select
                        ...
                        id=""
                    >
                        <option value="">Seleccinar marca</option>
                        {brandState.map((i, j) => {
                            return (
